    ...
    <div class="container py-5">
      <div class="text-center pb-4">
        <span class="text-light" style="font-weight: 400; color: black;">
          <h3>Registrasi Yuk ke Triple-A Train</h3>
        </span>
      </div>
      <div class="card card-train" style="border-radius: 20px; padding: 8px; background-color: #602436 !important; border: 1px solid #d0d0d0 !important;">
        <div class="card-body">
          ...
          <form method="POST">
            ...
            <button type="submit" class="btn btn-warning text-dark btn-block rounded-pill mt-4" style="color: white;">Registrasi</button>
            <hr>
            <a class="btn btn-secondary btn-block rounded-pill" href="login.php">Masuk ke Triple-A Train</a>
          </form>
        </div>
      </div>
    </div>
