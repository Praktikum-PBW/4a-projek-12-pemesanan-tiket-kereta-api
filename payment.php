...
<body>
  ...
  <section style="background-color: #4c0120;">
    <div class="container pt-5">
      <nav>
        <ol class="breadcrumb justify-content-center" style="margin-bottom: 0px; background-color: #4c0120; color: white;">
  ...
  <section style="background-color: #4c0120;">
    <div class="container pt-5" style="padding-bottom: 50px;">
      <form action="ticket.php" method="post">
        <div class="row">
          <div class="col-md-8">
            <div class="card" style="margin-bottom: 0px; background-color: #602436; color: white; border: 1px solid #d0d0d0 !important;">
              <div class="card-body">
                <h5 class="card-title">Metode Pembayaran</h5>
                <div class="alert alert-primary" role="alert" style="background-color: #7a4a88; color: white; border: 1px solid #7a4a88;">
                  <a href="login.php" style="color: #ffc107">Log In</a> atau <a href="register" style="color: #ffc107">Daftar</a> untuk menyimpan daftar pemesanan kamu.
                </div>
                <div class="accordion" id="accordion_payment">
                  <div class="card" style="background-color: #4c0120 !important; color: white;">
                    <div class="card-header" id="headingOne" style="padding: .75rem .50rem; background-color: #663047 !important;">
                      <h2 class="mb-0">
                      ...
                      <div class="card-body">
                        ...
                        <table class="table" style="margin-bottom: 0;">
                          <tbody>
                            ...
                            <tr>
                              <td colspan="2">
                                <p class="text-center" style="color: #ffc107;">Mohon transfer sesuai dengan yang tertera!</p>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                  ...
                  <div class="card" style="background-color: #4c0120 !important; color: white;">
                    <div class="card-header" id="headingFour" style="padding: .75rem .50rem; background-color: #663047 !important;">
                      <h2 class="mb-0">
                  ...
                  <div class="card" style="background-color: #4c0120 !important; color: white;">
                    <div class="card-header" id="headingTwo" style="padding: .75rem .50rem; background-color: #663047 !important;">
                      <h2 class="mb-0">
                  ...
                  <div class="card" style="background-color: #4c0120 !important; color: white;">
                    <div class="card-header" id="headingThree" style="padding: .75rem .50rem; background-color: #663047 !important;">
                      <h2 class="mb-0">
                  ...
                  <label class="mt-2">Anda bisa membayar dengan melalui Metode Pembayaran yang tersedia.</label>
                </div>
                <hr>
                <span>Apabila sudah dibayar maka silahkan konfirmasi menggunakan tombol berikut, setelah itu sistem akan automatis mengkonfirmasi pembayaran kamu.</span>
                <div class="row">
                  <div class="col-md-8"></div>
                  <div class="col-md-4">
                    <a class="btn btn-warning text-dark angemt-2 text-white rounded-pill" href="ticket.php?trans_id=<?= $random; ?>" style="display: block;">Lanjutkan</a>
                  </div>
                </div>
              </div>
            </div>
