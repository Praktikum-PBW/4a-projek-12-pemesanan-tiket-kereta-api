...
<body>
  ...
  <section style="background-color: #4c0120;">
    <div class="container">
      <div class="row pt-4">
        <div class="col-md-3">
          <div class="card" style="min-height: 82.1vh; background-color: #602436; color: white; border: 1px solid #d0d0d0 !important;">
            <div class="card-body">
              ...
              <a href="account.php" class="btn btn-warning text-dark btn-block text-left"><i class="fas fa-cog" style="margin-right: 10px;"></i>Pengaturan Saya</a>
        ...
        <div class="col-md-9" style='background-color: #602436; color: white; border: 1px solid #d0d0d0 !important;'>
          <div class="card" style="background-color: #602436; color: white; border: 1px solid #602436 !important;">
            <div class="card-body">
              <?php if ($_POST) : ?>
              ...
              <form method="POST">
                ...
                <button type="submit" class="btn btn-warning text-dark btn-block rounded-pill text-white">Simpan</button>
              </form>
            </div>
          </div>
        </div>
