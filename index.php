...
<body>
  ...
  <div class="jumbotron jumbotron-fluid">
    <div class="container">
      <div class="row">
        <div class="col-md-7">
          <h1 class="display-5 text-left">Temukan Tiket Kereta di Triple-A Train</h1>
          <p class="lead">Bingung beli tiket kereta murah dimana? <strong>Triple-A Train</strong> aja! Mulai dari kereta uap,
            disel, listrik pun ada di sini.</p>
        </div>
        <div class="col-md-5">
          <img class="ml-0 mt-0" src=" ./img/trainindex.png" alt="Triple-A Train" style="overflow:auto;">
        </div>
      </div>
      <hr class="my-4">
      <p>Yuk isi data-data di bawah untuk mencari tiket kereta:</p>
      <form method="GET" action="#train-details">
        <div class="row">
          ...
          <div class="col-md-3 mt-4 mb-0 pl-1">
            <button class="btn btn-warning text-dark btn-block rounded-pill" style="color: white; height: 50px;">Cari Kereta <i class="pl-2 fas fa-fw fa-search"></i></button>
          </div>
        </div>
      </form>
    </div>
  ...
  <section id="train-details">
    <div class="container py-5">
      <h4 class="text-center text-light pb-5">- Detail kereta yang ditemukan -</h4>
      <?php if (isset($trains_result)) : ?>
        <div class="row mt-4">
          <?php foreach ($trains_result as $train) : ?>
            <div class="col-md-12 mt-2">
              <div class="card card-train-details">
                <div class="row" style="background-color: #602436 !important; border: 1px solid #d0d0d0 !important;">
                  <div class="col-md-4">
                    <div class="card-body">
                  ...
                  <div class="col-md-4">
                    <div class="card-body text-right">
                      ...
                      <a href="transactions.php?train=<?= $train['train']; ?>&class=<?= $train['class'] ?>&dept_station=<?= $train['dept_station'] ?>&arr_station=<?= $train['arr_station'] ?>&time-dept-arr=<?= $_GET['time-dept-arr'] ?>&time_dept=<?= $train['dept']; ?>&price=<?= $train['price']; ?>&unique-price=<?= $unique_price; ?>" class="btn btn-outline-warning rounded-pill" style="color: white;">Pilih Paket</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <?php else : ?>
        <img class="mx-auto d-block" style="position: relative; height: 200px;" src="./img/kereta 404.png" alt="Search Train">
