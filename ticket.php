...
<body>
  ...
  <section style="background-color: #4c0120;">
    <div class="container pt-5">
      <nav>
        <ol class="breadcrumb justify-content-center" style="margin-bottom: 0px; background-color: #4c0120 !important; color: white;">
  ...
  <section style="background-color: #4c0120;">
    <div class="container pt-5" style="padding-bottom: 50px;">
      <form action="ticket.php" method="post">
        <div class="row">
          <div class="col-md-12">
            <div class="card" style="margin-bottom: 0px; background-color: #602436 !important; color: white; border: 1px solid #d0d0d0 !important;">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 text-right">
                    ...
                    <div class="col mt-lg-0 mt-sm-3">
                      <a class="btn btn-warning text-dark rounded-pill text-light" style="width:100%;" href="./index.php">Kembali Ke Beranda</a>
                    </div>
