      ...
      <form action="payment.php" method="post">
        <div class="row">
          <div class="col-md-8">
              ...
              <div class="card-body">
                ...
                <?php if (isset($_SESSION['email'])) : ?>
                  ...
                  <div class="alert alert-primary" role="alert" style="background-color: #7a4a88; color: white; border: 1px solid #7a4a88;">
                    Halo, <?= $akun['name'] ?>! Silahkan memesan tiket kamu.
                  </div>
                <?php else : ?>
                  <div class="alert alert-primary" role="alert" style="background-color: #7a4a88; color: white; border: 1px solid #7a4a88;">
            ...
            <div class="card mt-4" style="margin-bottom: 0px; background-color: #602436; color: white; border: 1px solid #d0d0d0 !important;">
              <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <span class="input-group-btn">
                          <button type="button" class="btn btn-warning text-dark btn-number" disabled="disabled" data-type="minus" data-field="quant[1]">
                            <span class="fa fa-minus"></span>
                          </button>
                        </span>
                        <input type="text" name="quant[1]" class="form-control input-number" value="1" min="1" max="10" readonly>
                        <span class="input-group-btn">
                          <button type="button" class="btn btn-warning text-dark btn-number" data-type="plus" data-field="quant[1]">
          ...
          <div class="col-md-4">
            <div class="card" style="margin-bottom: 0px; background-color: #602436; color: white; border: 1px solid #d0d0d0 !important; position: sticky;">
              <div class="card-body">
                ...
                <div class="text-right">
                  <button type="submit" class="btn btn-warning text-dark rounded-pill" style="color: white; font-size: 14px;">Lanjutkan pembayaran</button>
                </div>
              </div>
            </div>
          </div>
